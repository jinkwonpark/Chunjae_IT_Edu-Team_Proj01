...
<%
    ...
    String path56 = request.getContextPath();
    ...
    if(cnt>0){
        if(target.equals("admin")) {
            response.sendRedirect(path56 + "/admin/studentboardMgmt.jsp?page=1");
        } else {
            response.sendRedirect(path56 + "/board/studentboard/StudentBoardList.jsp?page=1");
        }
    } else {
