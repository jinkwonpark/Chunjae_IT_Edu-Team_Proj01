...
<head>
    ...
    <link rel="stylesheet" href="<%=path21%>/css/login.css">
        ...
        <div class="container">
            <div class="box_wrap">
                <ul class="list row">
                    <li class="col-3">
                        <div class="card">
                            <img src="<%=path21%>/images/book04.png" class="card-img-top" alt="강의소개">
                            <div class="card-body">
                    ...
                    <li class="col-3">
                        <div class="card">
                            <img src="<%=path21%>/images/book03.png" class="card-img-top" alt="강의소개">
                            <div class="card-body">
                                <h5 class="card-title">중등 국어</h5>
                    ...
                    <li class="col-3">
                        <div class="card">
                            <img src="<%=path21%>/images/book02.png" class="card-img-top" alt="강의소개">
                            <div class="card-body">
                                <h5 class="card-title">중등 국어</h5>
                    ...
                    <li class="col-3">
                        <div class="card">
                            <img src="<%=path21%>/images/book01.png" class="card-img-top" alt="강의소개">
                            <div class="card-body">
