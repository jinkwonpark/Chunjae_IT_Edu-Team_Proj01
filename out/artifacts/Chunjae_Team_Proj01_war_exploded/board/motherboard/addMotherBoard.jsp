...
<head>
    ...
    <link rel="stylesheet" href="<%=path11%>/css/google.css">
    <link rel="stylesheet" href="<%=path11%>/css/fonts.css">
    <link rel="stylesheet" href="<%=path11%>/css/content_header.css">

    <!-- 필요한 플러그인 연결 -->
    <script src="https://code.jquery.com/jquery-latest.js"></script>
    <link rel="stylesheet" href="<%=path11%>/css/common.css">
    <link rel="stylesheet" href="<%=path11%>/css/header.css">
    <style>
        /* 본문 영역 스타일 */
    ...
    <link rel="stylesheet" href="<%=path11%>/css/footer.css">
    <style>
    ...
    <div class="contents" id="contents">
        <div class="content_header">
            <div class="breadcrumb">
                <p><a href="<%=path11 %>">Home</a> &gt; <span> 학부모 커뮤니티 </span> </p>
        ...
        <section class="page" id="page1">
            <div class="page_wrap">
                ...
                <hr>
                <form action="<%=path11%>/board/motherboard/addMotherBoardPro.jsp" method="post">
                    <table class="tb1">
                        <tbody>
                        <tr>
