...
<%
    String path53 = request.getContextPath();
    ...
    if(cnt > 0){
        if(target.equals("admin")) {
            response.sendRedirect(path53+"/admin/motherboardMgmt.jsp?page=1");
        } else {
            response.sendRedirect(path53+"/board/motherboard/MotherBoardList.jsp?page=1");
        }
    } else {
